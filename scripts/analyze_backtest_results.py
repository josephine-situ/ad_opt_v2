...
Example:
    ...
    uv run python scripts/analyze_backtest_results.py --backtest-dir opt_results/sys_think/campaign/default/backtest/2025-10-06_2025-10-12
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--backtest-dir",
        default="",
        help="Explicit backtest output directory (overrides course/exp/start/end)",
    )
